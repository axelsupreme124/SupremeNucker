...
{
    std::system("clear");
    std::cout << termcolor::bold << termcolor::green << "⟡ SupremeCheat" << termcolor::reset << ": Car Parking Multiplayer Hacking ToolKit." << std::endl;
    std::cout << termcolor::bold << termcolor::green << "⟡ Telegram" << termcolor::reset << ": " << termcolor::blue << "@Unlikely_buisit" << termcolor::reset << " or " << termcolor::blue << "@Unlikely_buisit" << termcolor::reset << "."  << std::endl;
    std::cout << termcolor::bold << termcolor::green <<"⟡ Website" << termcolor::reset  << " : " << termcolor::blue << "https://axelsupremeshop.tiiny.site" << termcolor::reset << std::endl;
